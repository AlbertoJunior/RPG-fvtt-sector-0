export const CharacteristicType = Object.freeze({
    ...
    CONSCIOUSNESS_LEVEL: { id: 'consciencia_level', system: 'system.virtudes.consciencia.level' },
    CONSCIOUSNESS_USED: { id: 'consciencia_usada', system: 'system.virtudes.consciencia.used' },
    PERSEVERANCE_LEVEL: { id: 'perseveranca_level', system: 'system.virtudes.perseveranca.level' },
    PERSEVERANCE_USED: { id: 'perseveranca_usada', system: 'system.virtudes.perseveranca.used' },
    QUIETNESS_LEVEL: { id: 'quietude_level', system: 'system.virtudes.quietude.level' },
