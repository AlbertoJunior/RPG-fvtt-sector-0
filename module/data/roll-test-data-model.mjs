...
export class RollTestDataModel extends SchemaField {
    constructor() {
        super({
            ...
            ability: new StringField({ required: false, blank: true, initial: '', label: "S0.Habilidade" }),
    ...
    static _toJson(params) {
        const { id, name, primary_attribute, secondary_attribute, ability, bonus = 0, automatic = 0, difficulty = 6, critic = 10, specialist = false } = params;
